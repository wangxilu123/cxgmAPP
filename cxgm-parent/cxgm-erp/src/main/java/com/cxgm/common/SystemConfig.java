...
public class SystemConfig {
	...
	public void setPriceRoundType(String priceRoundType) {
		this.priceRoundType = RoundType.valueOf(priceRoundType);
	}
	...
	public void setOrderRoundType(String orderRoundType) {
		//this.orderRoundType = orderRoundType;
		this.orderRoundType = RoundType.valueOf(orderRoundType);
	}
	...
	public void setStoreFreezeTime(String storeFreezeTime) {
		...
		this.storeFreezeTime = StoreFreezeTime.valueOf(storeFreezeTime);
	}
	...
	public void setWatermarkPosition(String watermarkPosition) {
		...
		this.watermarkPosition = WatermarkPosition.valueOf(watermarkPosition);
	}
	...
	public void setPointType(String pointType) {
		...
		this.pointType = PointType.valueOf(pointType);
	}
